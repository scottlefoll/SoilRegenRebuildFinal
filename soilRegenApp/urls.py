...
urlpatterns = [
    ...
    # path('recipes/', views.RecipeController.as_view(), name='recipe_list'),
    # path('recipe_detail/<int:recipe_id>/', views.RecipeController.as_view(), name='recipe_detail'),
    # path('recipe/create/', views.RecipeController.as_view(), name='create_recipe'),
    # path('recipe/update/<int:recipe_id>/', views.RecipeController.as_view(), name='edit_recipe'),
    # path('recipe/delete/<int:recipe_id>/', views.RecipeController.as_view(), name='delete_recipe'),
