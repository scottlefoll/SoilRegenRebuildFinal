...
CREATE TABLE `recipe` (
  ...
  KEY `recipe_ibfk_1_idx` (`user_id`),
  CONSTRAINT `recipe_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_profile` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-03-23 15:55:37
